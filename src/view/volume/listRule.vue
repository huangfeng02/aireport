<template>
    ...
    <section class="content-header">
        ...
        <button data-toggle="modal" data-target="#myModal" class="btn btn-sm btn-primary pull-right" type="button">添加考核规则</button>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>首页</a></li>
            <li><a href="#">货量考核</a></li>
            <li class="active">货量考核规则管理</li>
        </ol>
    </section>
...
<script>
    ...
    import listModal from './listRuleModal.vue'
