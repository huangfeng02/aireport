        ...
        <div class="modal-dialog modal-cm" role="document">
            <div class="modal-content" id="addForm">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">添加舱位信息</h4>
                </div>
                    ...
                    <validator name="validation1">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" v-model="spaceSituation.airCompany" class="form-control" placeholder="航空公司">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea class="form-control" v-model="spaceSituation.content" rows="3" placeholder="描述"></textarea>
                                </div>
                            </div>
    ...
    export default {
        ...
        methods:{
            ...
            findById: function (id,airportCode,airline,airlineCompany) {
                this.spaceSituation.id=id
                this.airport.airportCode=airportCode
                this.spaceSituation.airline=airline
                $("#btm-submit-2").hide()
                $("#btm-update-2").show()
                $('#myModal2').modal('show')
            },
            update2:function(){
                var _this=this;
                var data = JSON.stringify(_this.spaceSituation);
                $.ajax({
        ...
        ready:function(){
            ...
            $('#myModal2').on('hidden.bs.modal', function (e) {
                //重置属性值为空
                for (var sProp in _this.spaceSituation) {
                    _this.spaceSituation[sProp]='';
                }
                $("#btm-submit-2").show()
                $("#btm-update-2").hide()
            })
