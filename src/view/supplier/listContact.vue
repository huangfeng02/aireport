<template>
    ...
    <list-modal :contact-info="contactInfo"></list-modal>
...
<script>
    ...
    import listModal from './listContactModal.vue'
    ...
    export default {
        ...
        mounted: function(transition){
            ...
            if(supplierId){
                ...
                this.contactInfo.supplierId=supplierId
                this.search()
            }else{
                this.listContact()
            }
